...
const BUSINESS_INFO = {
  ...
  menuPolicyText:'สำหรับรายละเอียดเมนู อาหาร เครื่องดื่ม และโปรโมชั่นสุดคุ้มของทางร้าน 🍻\nคุณลูกค้าสามารถคลิกดูรูปภาพอัปเดตล่าสุดได้ที่ลิงก์นี้เลยครับผม 👉 https://stickerthachang.my.canva.site/menu-promotionnn หากหากมีข้อสงสัย พิมพ์คำถามไว้รอแอดมินคนจริงมาตอบเพิ่มเติมได้เลยนะครับ'
};
...
จำกัด 1 โต๊ะ ไม่เกิน 6 คน (ไม่สามารถเกินได้ครับ)
