...
app.post('/chat', async (req, res) => {
  // รองรับการรับข้อมูลทั้งแบบ Object ปกติ และแบบ Array ที่ถูก Wrap มาจาก Zapier
  ...
  try {
    // ปรับสเปคกลับมาเป็นแบบ Non-streaming (รอคำตอบเสร็จแล้วส่งทีเดียว) เพื่อให้ Zapier อ่านค่าได้ง่าย
